                ...
                <div class="header-banner">
                    <div class="assetBlock">
                        <div style="height: 20px; overflow: hidden;" id="slideshow">
                            <p>Магазин Спортивного Питания</p>
                        </div>
                    </div>
                </div>
                        ...
                        <nav>
                            <div class="mm-toggle-wrap">
                                ...
                                <div class="nav-inner">
                                    ...
                                    <li class="mega-menu">
                                        <a class="level-top" href="grid.html"><span>Протеины</span></a>
    ...
    <div class="breadcrumbs">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <ul>
                        <li class="home"> <a href="index.html" title="Go to Home Page">Главная</a> <span>—› </span> </li>
                        <li class="category1599"> <a href="grid.html" title="">Протеины</a> <span>—› </span> </li>
                        <li class="category1600"> <a href="grid.html" title="">Сывороточные</a></li>
                    </ul>
                </div>
                <!--col-xs-12-->
            </div>
...
<li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
    <div class="item-inner">
        <div class="item-img">
            <div class="item-img-info"><a href="product-detail.html" title="Retis lapen casen" class="product-image"><img src="<?php echo SITE_DIR; ?>images/trash/1.jpg" alt="Retis lapen casen"></a>
...
<li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
    <div class="item-inner">
        <div class="item-img">
            <div class="item-img-info"><a href="product-detail.html" title="Retis lapen casen" class="product-image"><img src="<?php echo SITE_DIR; ?>images/trash/2.jpg" alt="Retis lapen casen"></a>
...
<li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
    <div class="item-inner">
        <div class="item-img">
            <div class="item-img-info"><a href="product-detail.html" title="Retis lapen casen" class="product-image"><img src="<?php echo SITE_DIR; ?>images/trash/3.jpg" alt="Retis lapen casen"></a>
